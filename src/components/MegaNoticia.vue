<template>
  ...
  <div class="row no-gutters">
    <div class="col-md-4">
      <img :src="news.img" class="card-img" style="object-fit: cover; object-position: center;" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body ">
...
export default {
  data() {
    return {
      news: {
        title:
          "Oaxaca está teniendo una exitosa temporada de exportación de mangos a EE. UU",
        img:
